    ...
    ui(new Ui::MainWindow)
{
    ...
    setWindowFlags(((windowFlags() | Qt::CustomizeWindowHint)
                             | Qt::WindowMinMaxButtonsHint)); // don't show buttons in title bar
    ...
    // ui->comboBox_algorithm->addItem(tr("SEEDS")); // opencv::ximgproc::createSuperpixelSEEDS function is noy working
...
void MainWindow::on_button_compute_clicked() // compute segmentation
{
    ...
    } /*else if (algorithm == 4) { //SEEDS
        seeds = cv::ximgproc::createSuperpixelSEEDS(image.cols, image.rows, converted.channels(), num_superpixels, num_levels, prior, num_histogram_bins, double_step); // Create superpixels container
